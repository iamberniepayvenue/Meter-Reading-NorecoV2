...
public class Constant {
    ...
    public static String FOOTERMESSAGE = "NOTE: Please pay in the office 2 days after receipt of this Statement of Account or within 7 days from Due Date to avoid Penalty.";
